  ...
  const clients = [
    {
      ...
      texte: "Nous créons et entretenons des jardins sur mesure, pensés pour votre confort, votre style de vie et votre environnement.",
    },
    {
      id: 2,
      titre: "Professionnels",
      image: professionnelsImg,
      texte: "Nous valorisons vos espaces extérieurs pour renforcer votre image, accueillir vos clients et améliorer le cadre de travail.",
    },
    {
      id: 3,
      titre: "Collectivités",
      image: collectivitesImg,
      texte: "Nous aménageons et entretenons des espaces publics durables, favorisant le bien-être des usagers et la biodiversité locale.",
    }
  ]
