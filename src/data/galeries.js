import conception1 from "../assets/images/prestations/prestation_01/conception1.png"
import conception2 from "../assets/images/prestations/prestation_01/conception2.png"
...
export const galeries = {
    conception: [
        {
            id: 1,
            src: conception1, alt:"Conception et réalisation d’espace verts"
        },
        {
            id: 2,
            src: conception2, alt:"Conception et réalisation d’espace verts"
        },
        {
            id: 3,
            src: conception3, alt:"Conception et réalisation d’espace verts"
        },
        {
            id: 4,
            src: conception4, alt:"Conception et réalisation d’espace verts"
        }
     ],
    entretien: [
        {
            id: 1,
            src: entretien1, alt:"Entretien des espaces verts"
        },
        {
            id: 2,
            src: entretien2, alt:"Entretien des espaces verts"
        },
        {
            id: 3,
            src: entretien3, alt:"Entretien des espaces verts"
        },
        {
            id: 4,
            src: entretien4, alt:"Entretien des espaces verts"
        }
    ],
    taille: [
        {
            id: 1,
            src: taille1, alt:"Taille des haies"
        },
        {
            id: 2,
            src: taille2, alt:"Taille des haies"
        },
        {
            id: 3,
            src: taille3, alt:"Taille des haies"
        },
        {
            id: 4,
            src: taille4, alt:"Taille des haies"
        },
    ],
    elagage: [
        {
            id: 1,
            src: elagage1, alt:"Élagage et abatage d’arbres"
        },
        {
            id: 2,
            src: elagage2, alt:"Élagage et abatage d’arbres"
        },
        {
            id: 3,
            src: elagage3, alt:"Élagage et abatage d’arbres"
        },
        {
            id: 4,
            src: elagage4, alt:"Élagage et abatage d’arbres"
        }
    ],
    dechets: [
        {
            id: 1,
            src: dechets1, alt:"Valorisation des déchets verts"
        },
        {
            id: 2,
            src: dechets2, alt:"Valorisation des déchets verts"
        },
        {
            id: 3,
            src: dechets3, alt:"Valorisation des déchets verts"
        },
        {
            id: 4,
            src: dechets4, alt:"Valorisation des déchets verts"
        }
    ],
}